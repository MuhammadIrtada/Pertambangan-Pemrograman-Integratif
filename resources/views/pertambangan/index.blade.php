                    ...
                    <div class="card-header pb-0 mb-3">
                        <div class="row">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0">Penyimpanan Minyak</h6>
                            </div>
                            <div class="col-6 text-end align-items-center">
                                <a class="btn bg-warning mb-0 text-white" href={{ route('pertambangan.create') }}><i
                                        class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Stock</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    @foreach ($pertambangans as $pertambangan)
                                        <tr>
                                            <td>
                                            ...
                                            <td class="align-middle text-end">
                                                ...
                                                <form action="{{ route('pertambangan.destroy', $pertambangan->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
